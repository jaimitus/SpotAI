...
export const translations = {
  en: {
    ...
    systemNewChat: "New chat",
    systemToggleTheme: "Toggle theme",
    systemCapture: "Capture screen region",
    systemIncognito: "Toggle incognito",
    systemSettings: "Open settings",
    systemHide: "Hide window",
    systemClear: "Clear conversation",
    incognito: "Incognito",
  ...
  es: {
    ...
    systemNewChat: "Nueva conversación",
    systemToggleTheme: "Cambiar tema",
    systemCapture: "Capturar región de pantalla",
    systemIncognito: "Activar incógnito",
    systemSettings: "Abrir ajustes",
    systemHide: "Ocultar ventana",
    systemClear: "Vaciar conversación",
    incognito: "Incógnito",
  ...
  de: {
    ...
    systemNewChat: "Neuer Chat",
    systemToggleTheme: "Design wechseln",
    systemCapture: "Bildschirmbereich erfassen",
    systemIncognito: "Inkognito umschalten",
    systemSettings: "Einstellungen öffnen",
    systemHide: "Fenster ausblenden",
    systemClear: "Unterhaltung leeren",
    incognito: "Inkognito",
  ...
  pt: {
    ...
    systemNewChat: "Nova conversa",
    systemToggleTheme: "Alternar tema",
    systemCapture: "Capturar região do ecrã",
    systemIncognito: "Alternar incógnito",
    systemSettings: "Abrir definições",
    systemHide: "Ocultar janela",
    systemClear: "Limpar conversa",
    incognito: "Incógnito",
  ...
  fr: {
    ...
    systemNewChat: "Nouvelle conversation",
    systemToggleTheme: "Changer de thème",
    systemCapture: "Capturer une région de l'écran",
    systemIncognito: "Basculer l'incognito",
    systemSettings: "Ouvrir les paramètres",
    systemHide: "Masquer la fenêtre",
    systemClear: "Effacer la conversation",
    incognito: "Incognito",
