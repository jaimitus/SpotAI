...
export const translations = {
  en: {
    ...
    shortcutErrorAction: "Shortcut unavailable — click to fix in Settings",
    stopStreaming: "Stop generating",
    retry: "Retry",
    ctaAskContext: "Ask about this selection",
    ...
    voiceLanguageDesc:
      "Whisper transcribes in the chosen language; Auto detects it from the audio (less reliable on short clips).",
    ...
    ragTitle: "Ask your files",
    ragDocuments: "documents",
    ragChunks: "chunks",
    ragDropFiles: "Drag & drop files here",
    ragSupportedFormats: "PDF, DOCX, TXT, MD, CSV, HTML, code and more",
    ragQueryPlaceholder: "Ask a question about your documents...",
    ragSearch: "Search",
    ragProcessing: "Processing...",
    ragInfo:
      "Embeddings are generated locally with Ollama (nomic-embed-text) or a fallback mode",
    ragUnsupportedFiles: "Unsupported file type",
    ragIndexError: "Failed to index files",
    ragQueryError: "Search failed",
    ragIndexing: "Indexing...",
    ragReady: "Ready to answer questions",
    ragAnalyzingStructure: "Analyzing structure...",
    ragDocumentsTitle: "Documents",
    ragSelectDocument: "Show suggestions for this document",
    ragSuggestionsTitle: "Suggested with your documents",
    ragSuggestionsLoading: "Reading your documents...",
    ragSuggestionsRefresh: "Regenerate suggestions",
    ragSuggestionAsk: "Ask this now",
  ...
  es: {
    ...
    shortcutErrorAction: "Atajo no disponible — clic para arreglarlo en Ajustes",
    stopStreaming: "Detener generación",
    retry: "Reintentar",
    ctaAskContext: "Preguntar sobre la selección",
    ...
    voiceLanguageDesc:
      "Whisper transcribe en el idioma elegido; Automático lo detecta del audio (menos fiable en clips cortos).",
    voiceLangAuto: "Automático (detectar)",
    micLabel: "Micrófono",
    ...
    // RAG (Retrieval-Augmented Generation)
    ragTitle: "Pregunta a tus archivos",
    ragDocuments: "documentos",
    ragChunks: "fragmentos",
    ragDropFiles: "Arrastra y suelta archivos aquí",
    ragSupportedFormats: "PDF, DOCX, TXT, MD, CSV, HTML, código y más",
    ragQueryPlaceholder: "Haz una pregunta sobre tus documentos...",
    ragSearch: "Buscar",
    ragProcessing: "Procesando...",
    ragInfo:
      "Los embeddings se generan localmente con Ollama (nomic-embed-text) o en modo de respaldo",
    ragUnsupportedFiles: "Tipo de archivo no soportado",
    ragIndexError: "Error al indexar",
    ragQueryError: "Error en la búsqueda",
    ragIndexing: "Indexando...",
    ragReady: "Listo para responder preguntas",
    ragAnalyzingStructure: "Analizando estructura...",
    ragDocumentsTitle: "Documentos",
    ragSelectDocument: "Mostrar sugerencias de este documento",
    ragSuggestionsTitle: "Sugerido con tus documentos",
    ragSuggestionsLoading: "Leyendo tus documentos...",
    ragSuggestionsRefresh: "Regenerar sugerencias",
    ragSuggestionAsk: "Preguntar ahora",
  ...
  de: {
    ...
    shortcutErrorAction: "Kürzel nicht verfügbar — zum Beheben in den Einstellungen klicken",
    stopStreaming: "Generierung stoppen",
    retry: "Erneut versuchen",
    ctaAskContext: "Nach Auswahl fragen",
    ...
    streaming: "Antwortet",
    thinking: "Denkt nach…",
    viewReasoning: "Denkweise anzeigen",
    hideReasoning: "Denkweise ausblenden",
    error: "Fehler",
    done: "Fertig",
    response: "Antwort",
    stop: "Stopp",
    ...
    voiceLanguage: "Erkennungssprache",
    voiceLanguageDesc:
      "Whisper transkribiert in der gewählten Sprache; Automatisch erkennt es sie aus dem Audio (bei kurzen Clips weniger zuverlässig).",
    voiceLangAuto: "Automatisch (erkennen)",
    micLabel: "Mikrofon",
    ...
    // RAG (Retrieval-Augmented Generation)
    ragTitle: "Fragen Sie Ihre Dateien",
    ragDocuments: "Dokumente",
    ragChunks: "Segmente",
    ragDropFiles: "Dateien hierher ziehen",
    ragSupportedFormats: "PDF, DOCX, TXT, MD, CSV, HTML, Code und mehr",
    ragQueryPlaceholder: "Stellen Sie eine Frage zu Ihren Dokumenten...",
    ragSearch: "Suchen",
    ragProcessing: "Verarbeite...",
    ragInfo:
      "Embeddings werden lokal mit Ollama (nomic-embed-text) oder im Fallback-Modus erzeugt",
    ragUnsupportedFiles: "Nicht unterstützter Dateityp",
    ragIndexError: "Indexierung fehlgeschlagen",
    ragQueryError: "Suche fehlgeschlagen",
    ragIndexing: "Indexiere...",
    ragReady: "Bereit für Fragen",
    ragAnalyzingStructure: "Analysiere Struktur...",
    ragDocumentsTitle: "Dokumente",
    ragSelectDocument: "Vorschläge für dieses Dokument anzeigen",
    ragSuggestionsTitle: "Mit deinen Dokumenten vorgeschlagen",
    ragSuggestionsLoading: "Dokumente werden gelesen...",
    ragSuggestionsRefresh: "Vorschläge neu generieren",
    ragSuggestionAsk: "Jetzt fragen",
  ...
  pt: {
    ...
    shortcutErrorAction: "Atalho indisponível — clique para corrigir nas Definições",
    stopStreaming: "Parar geração",
    retry: "Tentar novamente",
    ctaAskContext: "Perguntar sobre a seleção",
    ...
    topP: "Top P",
    topK: "Top K",
    repeatPenalty: "Penalização de repetição",
    ...
    voiceLanguage: "Idioma de reconhecimento",
    voiceLanguageDesc:
      "O Whisper transcreve no idioma escolhido; Automático deteta a partir do áudio (menos fiável em clipes curtos).",
    voiceLangAuto: "Automático (detetar)",
    micLabel: "Microfone",
    ...
    // RAG (Retrieval-Augmented Generation)
    ragTitle: "Pergunte aos seus Arquivos",
    ragDocuments: "documentos",
    ragChunks: "segmentos",
    ragDropFiles: "Arraste e solte arquivos aqui",
    ragSupportedFormats: "PDF, DOCX, TXT, MD, CSV, HTML, código e mais",
    ragQueryPlaceholder: "Faça uma pergunta sobre seus documentos...",
    ragSearch: "Pesquisar",
    ragProcessing: "Processando...",
    ragInfo: "Embeddings gerados localmente com Ollama (nomic-embed-text) ou modo fallback",
    ragUnsupportedFiles: "Tipo de arquivo não suportado",
    ragIndexError: "Erro ao indexar",
    ragQueryError: "Erro ao pesquisar",
    ragIndexing: "Indexando...",
    ragReady: "Pronto para responder perguntas",
    ragAnalyzingStructure: "Analisando estrutura...",
    ragDocumentsTitle: "Documentos",
    ragSelectDocument: "Mostrar sugestões para este documento",
    ragSuggestionsTitle: "Sugerido com os seus documentos",
    ragSuggestionsLoading: "A ler os seus documentos...",
    ragSuggestionsRefresh: "Gerar novas sugestões",
    ragSuggestionAsk: "Perguntar agora",
    ragAutoContext: "Incluir contexto de documentos",
    ragAutoContextDesc:
  ...
  fr: {
    ...
    shortcutErrorAction: "Raccourci indisponible — cliquer pour le corriger dans les Paramètres",
    stopStreaming: "Arrêter la génération",
    retry: "Réessayer",
    ctaAskContext: "Poser une question sur la sélection",
    ...
    voiceLanguage: "Langue de reconnaissance",
    voiceLanguageDesc:
      "Whisper transcrit dans la langue choisie ; Auto la détecte depuis l'audio (moins fiable sur les clips courts).",
    voiceLangAuto: "Auto (détecter)",
    micLabel: "Microphone",
    ...
    // RAG (Retrieval-Augmented Generation)
    ragTitle: "Questionnez vos fichiers",
    ragDocuments: "documents",
    ragChunks: "segments",
    ragDropFiles: "Glissez-déposez des fichiers ici",
    ragSupportedFormats: "PDF, DOCX, TXT, MD, CSV, HTML, code et plus",
    ragQueryPlaceholder: "Posez une question sur vos documents...",
    ragSearch: "Rechercher",
    ragProcessing: "Traitement en cours...",
    ragInfo: "Les embeddings sont générés localement avec Ollama (nomic-embed-text) ou en mode dégradé",
    ragUnsupportedFiles: "Type de fichier non pris en charge",
    ragIndexError: "Erreur lors de l'indexation",
    ragQueryError: "Erreur lors de la recherche",
    ragIndexing: "Indexation...",
    ragReady: "Prêt à répondre aux questions",
    ragAnalyzingStructure: "Analyse de la structure...",
    ragDocumentsTitle: "Documents",
    ragSelectDocument: "Afficher les suggestions pour ce document",
    ragSuggestionsTitle: "Suggestions avec vos documents",
    ragSuggestionsLoading: "Lecture de vos documents...",
    ragSuggestionsRefresh: "Régénérer les suggestions",
    ragSuggestionAsk: "Demander maintenant",
