...
[![Release](https://img.shields.io/badge/version-1.3.4-cyan.svg)](https://github.com/jaimitus/SpotAI/releases)
...
- ⚡ **Installer (NSIS)**: `SpotAI_1.3.4_x64-setup.exe`
- 📦 **Installer (MSI)**: `SpotAI_1.3.4_x64_en-US.msi`
     ...
     ```json
     {
       ...
       "platforms": {
         "windows-x86_64": {
           ...
           "url": "https://github.com/jaimitus/SpotAI/releases/download/v1.3.4/SpotAI_1.3.4_x64-setup.exe"
         }
       }
     }
     ```
